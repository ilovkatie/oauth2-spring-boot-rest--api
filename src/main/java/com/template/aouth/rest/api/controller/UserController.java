...
import com.template.aouth.rest.api.service.SecurityService;
...
public class UserController {
    ...
    public String registration(@ModelAttribute("userForm") Account userForm, BindingResult bindingResult, Model model) {
        String passwordBeforeEncoding = userForm.getPassword();
        accountService.save(userForm);

        securityService.autologin(userForm.getUsername(), passwordBeforeEncoding);
